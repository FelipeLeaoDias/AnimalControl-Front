...
export class CreateCategoriaModal extends Component {
  constructor(props){
    super(props)
  }
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContainer}>
            ...
            <TextInput
              ...
              value={this.props.newCateTitle}
              onChangeText={this.props.onChangeCateName}
              placeholder="Digite o nome da categoria"
            />

            <TouchableOpacity style={styles.buttonModal} onPress={this.props.createCate}>
